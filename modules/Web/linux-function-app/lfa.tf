resource "azurerm_linux_function_app" "function_app" {
  name                        = coalesce(var.linux_function_app_name, "${var.project}-${var.environment}-func")
  service_plan_id             = var.service_plan_id
  location                    = var.location
  resource_group_name         = var.resource_group_name
  app_settings                = var.enable_app_insights == true ? merge(var.app_insights_settings_map, var.app_settings) : var.app_settings
