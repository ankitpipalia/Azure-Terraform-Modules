...
| names | Names to be applied to resources (inclusive) | <pre>object({<br>    environment         = string<br>    location            = string<br>    market              = string<br>    project_name        = string<br>    resource_group_type = string<br>  })</pre> | n/a | yes |
